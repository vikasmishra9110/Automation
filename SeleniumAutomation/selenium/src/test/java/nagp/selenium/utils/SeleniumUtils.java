...
public class SeleniumUtils {
	private static final int waitDuration = Integer.parseInt(PropertyReader.getValue("globalwait"));
	 ...
	 * @param webElements
	 */
	public static List<WebElement> waitForVisibilityOfElements(WebDriver driver, List<WebElement> webElements) {
		ArrayList<String> data = new ArrayList<String>();
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(waitDuration));
		wait.until(ExpectedConditions.visibilityOfAllElements(webElements));
		return webElements;
	...
	/**
	 * This method is to select value in dropdown by visible text
	 * 
	 * @param driver
	 * @param element
	 * @param value
	 */
	public static void selectByText(WebDriver driver, WebElement element, String value) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(waitDuration));
		wait.until(ExpectedConditions.visibilityOf(element));
