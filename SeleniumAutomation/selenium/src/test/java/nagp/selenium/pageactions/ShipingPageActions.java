...
public class ShipingPageActions {
	...
	public void fillShipingAddress() {
		try {
			...
			SeleniumUtils.scrollToWebElement(driver, shippingPageObjects.stateProvinceDropDown);
			SeleniumUtils.selectByText(driver, shippingPageObjects.stateProvinceDropDown,
					PropertyReader.getValue("State"));
			SeleniumUtils.setValue(driver, shippingPageObjects.phoneNo, PropertyReader.getValue("PhoneNo"));
			SeleniumUtils.click(driver, shippingPageObjects.shippingMethod);
			SeleniumUtils.clickElementByJse(driver, shippingPageObjects.nextButton);
			SeleniumUtils.clickElementByJse(driver, shippingPageObjects.placeOrderButton);
		} catch (Exception e) {
