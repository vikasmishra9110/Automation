...
public class CreateAccountPageActions {
	 ...
	 * @param password
	 */
	public void createNewUser(String firstName, String lastName, String email, String password, boolean existingUser) {
		...
		if (existingUser) {
			LOGGER.info("First name of new user is : " + PropertyReader.getValue("ExistingUserEmailId"));
			SeleniumUtils.setValue(driver, createAccountPageObjects.emailId,
					PropertyReader.getValue("ExistingUserEmailId"));
		} else {
